#include "pSystem.h"
const DWORD gameA::Particle::FVF = D3DFVF_XYZ | D3DFVF_DIFFUSE;
...
namespace gameA
{
	...
	void Snow::resetParticle(Attribute* attribute)
	{
		...
		attribute->_position.x = getRandomFloat(-10, 10);
		attribute->_position.y= getRandomFloat(-10, 10);
		attribute->_position.z = getRandomFloat(-10, 10);
